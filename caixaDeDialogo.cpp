...
void ReadDialogue(int posx, int posy, int partToStart, int partToStop, char txtChanger[20], char *Arquivo, void* Sprites_Retratos[], void* Sprites_Retratos_Mascaras[], void* Sprites_HUD[], void* Sprites_HUD_Mascaras[])
{
	int sizeyTemp = posy,
	 	sizexTemp = posx + 9,
	 	contLines = 1;
