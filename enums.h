...
enum RetratoBatalhaPersonagem {RBLILY, RBCHADDRIT, RBCAFE, RBCARACOL, RBGOLEM, RBPOCAO};
enum RetratoBatalhaTipo {RETRATOBATALHANORMAL, RETRATOBATALHAATACANDO, RETRATOBATALHADANO, RETRATOBATALHANOCAUTEADO};

enum RetratosImagens {LILYNORMAL, MORCEGONORMAL, BLILYNORMAL, BLILYATACANDO, BLILYLEVANDODANO, BLILYSEMHP, BCHADDRITNORMAL, BCHADDRITATACANDO, BCHADDRITLEVANDODANO, BCHADDRITSEMHP, BCAFERETRATO, BCARACOLRETRATO, BGOLEMRETRATO, BPOCAORETRATO};
