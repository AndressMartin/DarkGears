...
enum ComandosDeSom {VOLUME1, VOLUME2, VOLUME3, PARAREFEITOSONORO, PARARMUSICA, CURSORMOVE, CURSORVOLTA, CURSORPRONTO, CURSORERRO, MUSICABATALHA, MUSICAVITORIA, SOMCORREBATALHA, SOMDEATAQUE, SOMDECURA, SOMDEREVIVER, SOMINIMIGOMORTO, SOMDEATAQUE2, SOMERROUATAQUE};
