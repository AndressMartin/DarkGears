...
enum RetratoBatalhaPersonagem {RBLILY, RBCHADDRIT, RBCAFE};
enum RetratoBatalhaTipo {RETRATOBATALHANORMAL, RETRATOBATALHAATACANDO, RETRATOBATALHADANO, RETRATOBATALHANOCAUTEADO};

enum RetratosImagens {LILYNORMAL, MORCEGONORMAL, BLILYNORMAL, BLILYATACANDO, BLILYLEVANDODANO, BLILYSEMHP, BCHADDRITNORMAL, BCHADDRITATACANDO, BCHADDRITLEVANDODANO, BCHADDRITSEMHP, BCAFERETRATO};
...
enum ComandosDeSom {VOLUME1, VOLUME2, VOLUME3, PARAREFEITOSONORO, PARARMUSICA, CURSORMOVE, CURSORVOLTA, CURSORPRONTO, CURSORERRO, MUSICABATALHA, MUSICAVITORIA, SOMCORREBATALHA, SOMDEATAQUE, SOMDECURA, SOMDEREVIVER, SOMINIMIGOMORTO, SOMDEATAQUE2, SOMERROUATAQUE, SOMDECURA2};
