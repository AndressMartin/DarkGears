...
//Enumera os cenarios de batalha
enum CenariosBatalhaNome {CENARIOBATALHA1, CENARIOBATALHA2};
...
enum ImagensHUD {CAIXADETEXTO, MENUBATALHA1, MENUBATALHA2, MENUBATALHA3, SELECAOM, MENUBATALHAR, MENUBATALHAR2, MENUBATALHA4, TELADETITULO, BOTAOJOGAR, BOTAOCREDITOS, BOTAOSAIR, TELADECREDITOS, MENUINVENTARIO1, BOTAOATACAR, BOTAOHABILIDADES, BOTAOHABILIDADES2, BOTAOITENS, BOTAOCORRER, BOTAOCORRER2};

//Enumera os tipos de retratos de batalha
enum RetratoBatalhaPersonagem {RBLILY, RBCHADDRIT, RBCAFE, RBCARACOL, RBGOLEM, RBPOCAO, RBPOCAO2, RBPOCAO3, RBWUMPUS};
enum RetratoBatalhaTipo {RETRATOBATALHANORMAL, RETRATOBATALHAATACANDO, RETRATOBATALHADANO, RETRATOBATALHANOCAUTEADO};

enum RetratosImagens {LILYNORMAL, MORCEGONORMAL, BLILYNORMAL, BLILYATACANDO, BLILYLEVANDODANO, BLILYSEMHP, BCHADDRITNORMAL, BCHADDRITATACANDO, BCHADDRITLEVANDODANO, BCHADDRITSEMHP, BCAFERETRATO, BCARACOLRETRATO, BGOLEMRETRATO, BPOCAORETRATO, BPOCAO2RETRATO, BPOCAO3RETRATO, LILYASSUSTADA, LILYASSUSTADACLEAR, LILYSMIRK, CHADDRITNORMAL, CHADDRITMEE, BWUMPUSRETRATO};
...
enum ComandosDeSom {VOLUME1, VOLUME2, VOLUME3, PARAREFEITOSONORO, PARARMUSICA, CURSORMOVE, CURSORVOLTA, CURSORPRONTO, CURSORERRO, MUSICABATALHA, MUSICAVITORIA, MUSICAGAMEOVER, MUSICACAVERNA, MUSICACHEFE, SOMCORREBATALHA, SOMDEATAQUE, SOMDECURA, SOMDEREVIVER, SOMINIMIGOMORTO, SOMDEATAQUE2, SOMERROUATAQUE, SOMDECURA2, SOMABRIRBAU};
