...
enum RetratoBatalhaPersonagem {RBLILY, RBCHADDRIT, RBCAFE, RBCARACOL, RBGOLEM, RBPOCAO, RBPOCAO2, RBPOCAO3};
enum RetratoBatalhaTipo {RETRATOBATALHANORMAL, RETRATOBATALHAATACANDO, RETRATOBATALHADANO, RETRATOBATALHANOCAUTEADO};

enum RetratosImagens {LILYNORMAL, MORCEGONORMAL, BLILYNORMAL, BLILYATACANDO, BLILYLEVANDODANO, BLILYSEMHP, BCHADDRITNORMAL, BCHADDRITATACANDO, BCHADDRITLEVANDODANO, BCHADDRITSEMHP, BCAFERETRATO, BCARACOLRETRATO, BGOLEMRETRATO, BPOCAORETRATO, BPOCAO2RETRATO, BPOCAO3RETRATO};
